...
namespace Square.Apis
{
    internal class LocationsApi: BaseApi, ILocationsApi
    {
        ...
        /// <param name="body">Required parameter: An object containing the fields to POST for the request.  See the corresponding object definition for field details.</param>
        /// <return>Returns the Models.CreateLocationResponse response from the API call</return>
        public async Task<Models.CreateLocationResponse> CreateLocationAsync(Models.CreateLocationRequest body)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <param name="locationId">Required parameter: The ID of the location to retrieve.</param>
        /// <return>Returns the Models.RetrieveLocationResponse response from the API call</return>
        public async Task<Models.RetrieveLocationResponse> RetrieveLocationAsync(string locationId)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <param name="body">Required parameter: An object containing the fields to POST for the request.  See the corresponding object definition for field details.</param>
        /// <return>Returns the Models.UpdateLocationResponse response from the API call</return>
        public async Task<Models.UpdateLocationResponse> UpdateLocationAsync(string locationId, Models.UpdateLocationRequest body)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
