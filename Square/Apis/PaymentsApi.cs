...
namespace Square.Apis
{
    ...
    internal class PaymentsApi : BaseApi, IPaymentsApi
    {
        ...
        public Models.ListPaymentsResponse ListPayments(
            ...
            => CoreHelper.RunTask(ListPaymentsAsync(beginTime, endTime, sortOrder, cursor, locationId, total, last4, cardBrand, limit, isOfflinePayment, offlineBeginTime, offlineEndTime, updatedAtBeginTime, updatedAtEndTime, sortField));
