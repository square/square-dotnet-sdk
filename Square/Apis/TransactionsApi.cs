...
namespace Square.Apis
{
    internal class TransactionsApi: BaseApi, ITransactionsApi
    {
        ...
        /// <return>Returns the Models.ChargeResponse response from the API call</return>
        [Obsolete]
        public async Task<Models.ChargeResponse> ChargeAsync(string locationId, Models.ChargeRequest body)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <return>Returns the Models.RetrieveTransactionResponse response from the API call</return>
        [Obsolete]
        public async Task<Models.RetrieveTransactionResponse> RetrieveTransactionAsync(string locationId, string transactionId)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <return>Returns the Models.CaptureTransactionResponse response from the API call</return>
        [Obsolete]
        public async Task<Models.CaptureTransactionResponse> CaptureTransactionAsync(string locationId, string transactionId)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <return>Returns the Models.CreateRefundResponse response from the API call</return>
        [Obsolete]
        public async Task<Models.CreateRefundResponse> CreateRefundAsync(string locationId, string transactionId, Models.CreateRefundRequest body)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
        ...
        /// <return>Returns the Models.VoidTransactionResponse response from the API call</return>
        [Obsolete]
        public async Task<Models.VoidTransactionResponse> VoidTransactionAsync(string locationId, string transactionId)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
