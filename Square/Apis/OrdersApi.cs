...
namespace Square.Apis
{
    internal class OrdersApi : BaseApi, IOrdersApi
    {
        ...
        public Models.RetrieveOrderResponse RetrieveOrder(string orderId)
        {
            Task<Models.RetrieveOrderResponse> t = RetrieveOrderAsync(orderId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="orderId">Required parameter: The ID of the order to retrieve.</param>
        /// <return>Returns the Models.RetrieveOrderResponse response from the API call</return>
        public async Task<Models.RetrieveOrderResponse> RetrieveOrderAsync(string orderId, CancellationToken cancellationToken = default)
        {
            //the base uri for api requests
            string _baseUri = config.GetBaseUri();
            ...
            var _responseModel = ApiHelper.JsonDeserialize<Models.RetrieveOrderResponse>(_response.Body);
            _responseModel.Context = _context;
            return _responseModel;
        }
