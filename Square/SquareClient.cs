namespace Square
{
    ...
    public sealed class SquareClient : ISquareClient
    {
        ...
        private const string userAgent = "Square-DotNet-SDK/30.0.0 ({api-version}) {engine}/{engine-version} ({os-info}) {detail}";
        ...
        /// </summary>
        public string SdkVersion => "30.0.0";
        ...
        {
            private string squareVersion = "2023-08-16";
