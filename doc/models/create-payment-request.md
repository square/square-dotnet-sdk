...
| `CustomerId` | `string` | Optional | The [Customer](entity:Customer) ID of the customer associated with the payment.<br><br>This is required if the `source_id` refers to a card on file created using the Cards API. |
...
| `TeamMemberId` | `string` | Optional | An optional [TeamMember](entity:TeamMember) ID to associate with<br>this payment. |
