...
|  --- | --- | --- | --- |
| `CustomAttributeDefinitions` | [`IList<Models.CustomAttributeDefinition>`](../../doc/models/custom-attribute-definition.md) | Required | The retrieved custom attribute definitions. If no custom attribute definitions are found, Square returns an empty object (`{}`). |
