...
| `Tenders` | [`IList<Tender>`](../../doc/models/tender.md) | Optional | The tenders used to pay in the transaction. |
| `Refunds` | [`IList<Refund>`](../../doc/models/refund.md) | Optional | Refunds that have been applied to any tender in the transaction. |
