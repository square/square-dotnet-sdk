...
| `CatalogObjectId` | `string` | Optional | The [CatalogItemVariation](entity:CatalogItemVariation) ID applied to this line item.<br>**Constraints**: *Maximum Length*: `192` |
...
| `Modifiers` | [`IList<Models.OrderLineItemModifier>`](../../doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](entity:CatalogModifier)s applied to this line item. |
