...
| `PricingRuleId` | `string` | Optional | The object ID of a [pricing rule](entity:CatalogPricingRule) to be applied<br>automatically to this discount. The specification and application of the discounts, to<br>which a `pricing_rule_id` is assigned, are completely controlled by the corresponding<br>pricing rule. |
