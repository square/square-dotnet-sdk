...
| `JpQii` | `string` | Optional | The QII (Qualified Invoice Issuer) number is a 14-character tax identifier used in Japan.<br>If it is present, it has been validated. For example, `T1234567890123`. |
