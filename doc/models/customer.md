...
| `GroupIds` | `IList<string>` | Optional | The IDs of [customer groups](../../doc/models/customer-group.md) the customer belongs to. |
| `SegmentIds` | `IList<string>` | Optional | The IDs of [customer segments](../../doc/models/customer-segment.md) the customer belongs to. |
