...
|  --- | --- | --- | --- |
| `StateFilter` | [`Models.SearchOrdersStateFilter`](/doc/models/search-orders-state-filter.md) | Optional | Filter by current Order `state`. |
...
| `FulfillmentFilter` | [`Models.SearchOrdersFulfillmentFilter`](/doc/models/search-orders-fulfillment-filter.md) | Optional | Filter based on [Order Fulfillment](/doc/models/order-fulfillment.md) information. |
| `SourceFilter` | [`Models.SearchOrdersSourceFilter`](/doc/models/search-orders-source-filter.md) | Optional | Filter based on order `source` information. |
| `CustomerFilter` | [`Models.SearchOrdersCustomerFilter`](/doc/models/search-orders-customer-filter.md) | Optional | Filter based on Order `customer_id` and any Tender `customer_id`<br>associated with the Order. Does not filter based on the<br>[FulfillmentRecipient](/doc/models/order-fulfillment-recipient.md) `customer_id`. |
