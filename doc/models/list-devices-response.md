...
|  --- | --- | --- | --- |
| `Errors` | [`IList<Error>`](../../doc/models/error.md) | Optional | Information about errors that occurred during the request. |
| `Devices` | [`IList<Device>`](../../doc/models/device.md) | Optional | The requested list of `Device` objects. |
