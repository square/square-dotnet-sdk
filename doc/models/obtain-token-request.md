...
| `RedirectUri` | `string` | Optional | The redirect URL assigned in the OAuth page for your application on the Developer Dashboard.<br>**Constraints**: *Maximum Length*: `2048` |
...
| `ShortLived` | `bool?` | Optional | A boolean indicating a request for a short-lived access token.<br>The short-lived access token returned in the response expires in 24 hours. |
