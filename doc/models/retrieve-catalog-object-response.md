...
| `MObject` | [`Models.CatalogObject`](/doc/models/catalog-object.md) | Optional | - |
| `RelatedObjects` | [`IList<Models.CatalogObject>`](/doc/models/catalog-object.md) | Optional | A list of CatalogObjects referenced by the object in the `object` field. |
