...
| `ItemData` | [`Models.CatalogItem`](/doc/models/catalog-item.md) | Optional | A [CatalogObject](#type-CatalogObject) instance of the `ITEM` type, also referred to as an item, in the catalog. |
