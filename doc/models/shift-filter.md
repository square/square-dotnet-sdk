...
|  --- | --- | --- | --- |
| `LocationIds` | `IList<string>` |  | Fetch shifts for the specified location. |
...
| `TeamMemberIds` | `IList<string>` |  | Fetch shifts for the specified team members. Replaced `employee_ids` at version "2020-08-26" |
