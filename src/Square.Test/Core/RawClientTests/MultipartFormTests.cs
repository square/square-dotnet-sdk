...
namespace Square.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Square.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Square.Core.MultipartFormRequest
        {
