...
namespace Square.Test.Unit.MockServer.Default.Inventory;
...
public class DeprecatedGetPhysicalCountTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v2/inventory/physical-count/physical_count_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Default.Inventory.DeprecatedGetPhysicalCountAsync(
