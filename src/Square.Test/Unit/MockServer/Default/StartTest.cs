...
public class StartTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v2/transfer-orders/transfer_order_id/start")
        ...
        var response = await Client.Default.TransferOrders.StartAsync(
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<StartTransferOrderResponse>(mockResponse))
                .UsingDefaults()
        );
    }
}
