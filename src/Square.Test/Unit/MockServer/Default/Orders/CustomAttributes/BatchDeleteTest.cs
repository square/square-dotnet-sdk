...
using Square.Default.Orders.CustomAttributes;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.Orders.CustomAttributes;
...
public class BatchDeleteTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.Orders.CustomAttributes.BatchDeleteAsync(
