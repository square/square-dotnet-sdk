...
using Square.Default.GiftCards.Activities;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.GiftCards.Activities;
...
public class CreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.GiftCards.Activities.CreateAsync(
