...
using Square.Default.CashDrawers.Shifts;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.CashDrawers.Shifts;
...
public class ListEventsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var items = await Client.Default.CashDrawers.Shifts.ListEventsAsync(
