...
namespace Square.Test.Unit.MockServer.Default.V1Transactions;
...
public class V1ListOrdersTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithParam("limit", "1")
                    .WithParam("batch_token", "batch_token")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Default.V1Transactions.V1ListOrdersAsync(
