...
namespace Square.Test.Unit.MockServer.Default.Terminal.Actions;
...
public class GetTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v2/terminals/actions/action_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Default.Terminal.Actions.GetAsync(
            new GetActionsRequest { ActionId = "action_id" }
        );
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<GetTerminalActionResponse>(mockResponse))
                .UsingDefaults()
        );
    }
}
