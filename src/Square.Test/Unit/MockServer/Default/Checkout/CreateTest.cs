...
using Square.Default.Checkout_;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.Checkout;
...
public class CreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.Checkout.PaymentLinks.CreateAsync(
