...
using Square.Default.Labor.WorkweekConfigs;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.Labor.WorkweekConfigs;
...
public class GetTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.Labor.WorkweekConfigs.GetAsync(
