...
using Square.Default.Labor.Shifts;
...
public class CreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.Labor.Shifts.CreateAsync(
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<CreateShiftResponse>(mockResponse)).UsingDefaults()
        );
    }
}
