...
using Square.Default.Bookings.CustomAttributes;
using Square.Test.Unit.MockServer;

namespace Square.Test.Unit.MockServer.Default.Bookings.CustomAttributes;
...
public class BatchUpsertTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Default.Bookings.CustomAttributes.BatchUpsertAsync(
