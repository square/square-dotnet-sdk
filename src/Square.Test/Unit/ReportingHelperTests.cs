...
public class ReportingHelperTests
{
    ...
    public void RealDeserializerContinueWaitBodyIsARetrySignalNotAResult()
    {
        ...
        // AdditionalProperties while the flat `data` payload stays absent. If this ever stops
        // being true, LoadAndWaitAsync would mistake "Continue wait" for a real result.
