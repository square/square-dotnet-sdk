...
[Serializable]
public record CatalogObjectSubscriptionPlanVariation : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    /// </summary>
    [JsonPropertyName("subscription_plan_variation_data")]
    public CatalogSubscriptionPlanVariation? SubscriptionPlanVariationData { get; set; }
