...
/// </summary>
[Serializable]
public record Fulfillment : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<FulfillmentFulfillmentEntry>? Entries { get; set; }
    ...
    public FulfillmentPickupDetails? PickupDetails { get; set; }
    ...
    public FulfillmentShipmentDetails? ShipmentDetails { get; set; }
