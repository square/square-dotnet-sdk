...
[Serializable]
public record CatalogObjectAvailabilityPeriod : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    /// </summary>
    [JsonPropertyName("availability_period_data")]
    public CatalogAvailabilityPeriod? AvailabilityPeriodData { get; set; }
