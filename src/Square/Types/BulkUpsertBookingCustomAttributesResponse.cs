...
/// </summary>
[Serializable]
public record BulkUpsertBookingCustomAttributesResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public Dictionary<string, BookingCustomAttributeUpsertResponse>? Values { get; set; }
