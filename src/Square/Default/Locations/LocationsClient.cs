...
public partial class LocationsClient : ILocationsClient
{
    ...
    internal LocationsClient(RawClient client)
    {
        ...
        CustomAttributeDefinitions =
            new Square.Default.Locations.CustomAttributeDefinitions.CustomAttributeDefinitionsClient(
                _client
            );
        CustomAttributes = new Square.Default.Locations.CustomAttributes.CustomAttributesClient(
            _client
        );
