...
public partial class LocationsClient : ILocationsClient
{
    ...
    {
        _client = client;
        CustomAttributeDefinitions = new Square.Default.Locations.CustomAttributeDefinitionsClient(
            _client
        );
        CustomAttributes = new Square.Default.Locations.CustomAttributesClient(_client);
        Transactions = new TransactionsClient(_client);
    }

    public Square.Default.Locations.CustomAttributeDefinitionsClient CustomAttributeDefinitions { get; }

    public Square.Default.Locations.CustomAttributesClient CustomAttributes { get; }
