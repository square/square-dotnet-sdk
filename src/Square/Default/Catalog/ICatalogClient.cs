...
using Square.Default.Catalog.Images;
using Square.Default.Catalog.Object;
...
public partial interface ICatalogClient
{
    ...
    /// </summary>
    Task<BatchDeleteCatalogObjectsResponse> BatchDeleteAsync(
    ...
    /// </summary>
    Task<BatchGetCatalogObjectsResponse> BatchGetAsync(
    ...
    /// </summary>
    Task<BatchUpsertCatalogObjectsResponse> BatchUpsertAsync(
    ...
    /// </summary>
    Task<CatalogInfoResponse> InfoAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<Pager<CatalogObject>> ListAsync(
    ...
    /// </summary>
    Task<SearchCatalogObjectsResponse> SearchAsync(
    ...
    /// </summary>
    Task<SearchCatalogItemsResponse> SearchItemsAsync(
    ...
    /// </summary>
    Task<UpdateItemModifierListsResponse> UpdateItemModifierListsAsync(
    ...
    /// </summary>
    Task<UpdateItemTaxesResponse> UpdateItemTaxesAsync(
