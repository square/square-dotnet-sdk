...
public partial class BookingsClient : IBookingsClient
{
    ...
    {
        _client = client;
        CustomAttributeDefinitions = new Square.Default.Bookings.CustomAttributeDefinitionsClient(
            _client
        );
        CustomAttributes = new Square.Default.Bookings.CustomAttributesClient(_client);
        LocationProfiles = new LocationProfilesClient(_client);
        TeamMemberProfiles = new TeamMemberProfilesClient(_client);
    }

    public Square.Default.Bookings.CustomAttributeDefinitionsClient CustomAttributeDefinitions { get; }

    public Square.Default.Bookings.CustomAttributesClient CustomAttributes { get; }
