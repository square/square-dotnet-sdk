...
public partial class BookingsClient : IBookingsClient
{
    ...
    internal BookingsClient(RawClient client)
    {
        ...
        CustomAttributeDefinitions =
            new Square.Default.Bookings.CustomAttributeDefinitions.CustomAttributeDefinitionsClient(
                _client
            );
        CustomAttributes = new Square.Default.Bookings.CustomAttributes.CustomAttributesClient(
            _client
        );
