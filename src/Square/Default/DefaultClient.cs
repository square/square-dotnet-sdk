...
public partial class DefaultClient : IDefaultClient
{
    ...
    internal DefaultClient(RawClient client)
    {
        ...
        Cards = new Square.Default.Cards.CardsClient(_client);
        ...
        Refunds = new Square.Default.Refunds.RefundsClient(_client);
        Sites = new SitesClient(_client);
        Snippets = new SnippetsClient(_client);
        Subscriptions = new Square.Default.Subscriptions.SubscriptionsClient(_client);
