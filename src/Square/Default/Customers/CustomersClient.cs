...
public partial class CustomersClient : ICustomersClient
{
    ...
    {
        _client = client;
        CustomAttributeDefinitions = new Square.Default.Customers.CustomAttributeDefinitionsClient(
            _client
        );
        Groups = new GroupsClient(_client);
        Segments = new SegmentsClient(_client);
        Cards = new Square.Default.Customers.CardsClient(_client);
        CustomAttributes = new Square.Default.Customers.CustomAttributesClient(_client);
    }
