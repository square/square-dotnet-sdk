...
public partial class MerchantsClient : IMerchantsClient
{
    ...
    {
        _client = client;
        CustomAttributeDefinitions = new Square.Default.Merchants.CustomAttributeDefinitionsClient(
            _client
        );
        CustomAttributes = new Square.Default.Merchants.CustomAttributesClient(_client);
    }
