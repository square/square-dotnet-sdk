...
public partial class MerchantsClient : IMerchantsClient
{
    ...
    internal MerchantsClient(RawClient client)
    {
        ...
        CustomAttributeDefinitions =
            new Square.Default.Merchants.CustomAttributeDefinitions.CustomAttributeDefinitionsClient(
                _client
            );
        CustomAttributes = new Square.Default.Merchants.CustomAttributes.CustomAttributesClient(
            _client
        );
    }

    public Square.Default.Merchants.CustomAttributeDefinitions.CustomAttributeDefinitionsClient CustomAttributeDefinitions { get; }

    public Square.Default.Merchants.CustomAttributes.CustomAttributesClient CustomAttributes { get; }
