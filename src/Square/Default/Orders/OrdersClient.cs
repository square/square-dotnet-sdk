...
public partial class OrdersClient : IOrdersClient
{
    ...
    internal OrdersClient(RawClient client)
    {
        ...
        CustomAttributeDefinitions =
            new Square.Default.Orders.CustomAttributeDefinitions.CustomAttributeDefinitionsClient(
                _client
            );
        CustomAttributes = new Square.Default.Orders.CustomAttributes.CustomAttributesClient(
            _client
        );
    }

    public Square.Default.Orders.CustomAttributeDefinitions.CustomAttributeDefinitionsClient CustomAttributeDefinitions { get; }

    public Square.Default.Orders.CustomAttributes.CustomAttributesClient CustomAttributes { get; }
