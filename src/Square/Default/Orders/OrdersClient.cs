...
public partial class OrdersClient : IOrdersClient
{
    ...
    {
        _client = client;
        CustomAttributeDefinitions = new Square.Default.Orders.CustomAttributeDefinitionsClient(
            _client
        );
        CustomAttributes = new Square.Default.Orders.CustomAttributesClient(_client);
    }
