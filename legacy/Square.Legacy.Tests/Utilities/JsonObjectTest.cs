...
namespace Square.Legacy.Tests.Utilities
{
    [TestFixture]
    public class JsonObjectTest
    {
        ...
        public void NonEmptyObjectTest()
        {
            ...
            Assert.AreEqual(
                "{\"stringProp\":\"test 1\",\"boolProp\":true,\"numProp\":5.12,\"arrayProp\":[\"test 2\"],\"objProp\":{\"childProp\":true},\"nullProp\":null}",
                obj.ToString()
            );
            ...
            var expected = new TestObject
            {
                ...
                objProp = new TestObject.TestChildObject { childProp = true },
                nullProp = null,
            };
        ...
        public void NonObjectTest()
        {
            ...
            Assert.AreEqual(
                "Error reading JObject from JsonReader. Current JsonReader item is not an object: Boolean. Path '', line 1, position 4.",
                ex.Message
            );
            ex = Assert.Throws<JsonReaderException>(
                () => JsonObject.FromJsonString("\"hello world\"")
            );
            Assert.AreEqual(
                "Error reading JObject from JsonReader. Current JsonReader item is not an object: String. Path '', line 1, position 13.",
                ex.Message
            );
