...
|  --- | --- | --- | --- |
| `DisputeId` | `string` | Optional | The unique ID for this `Dispute`, generated by Square.Legacy.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `40` |
| `Id` | `string` | Optional | The unique ID for this `Dispute`, generated by Square.Legacy.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `40` |
