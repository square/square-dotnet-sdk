...
|  --- | --- | --- | --- |
| `Id` | `string` | Required | The unique ID for this refund, generated by Square.Legacy.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255` |
...
| `Unlinked` | `bool?` | Optional | Flag indicating whether or not the refund is linked to an existing payment in Square.Legacy. |
...
| `TerminalRefundId` | `string` | Optional | An optional ID for a Terminal refund. |
