...
| `Components` | [`IList<Component>`](../../doc/models/component.md) | Optional | A list of components applicable to the device. |
| `Status` | [`DeviceStatus`](../../doc/models/device-status.md) | Optional | - |
