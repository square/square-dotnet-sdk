...
namespace Square.Legacy.Apis
{
    ...
    public interface IVendorsApi
    {
        ...
        Models.BulkCreateVendorsResponse BulkCreateVendors(Models.BulkCreateVendorsRequest body);
        ...
        Models.BulkUpdateVendorsResponse BulkUpdateVendors(Models.BulkUpdateVendorsRequest body);
        ...
        Models.CreateVendorResponse CreateVendor(Models.CreateVendorRequest body);
        ...
        Models.SearchVendorsResponse SearchVendors(Models.SearchVendorsRequest body);
        ...
        Models.RetrieveVendorResponse RetrieveVendor(string vendorId);
        ...
        Models.UpdateVendorResponse UpdateVendor(Models.UpdateVendorRequest body, string vendorId);
