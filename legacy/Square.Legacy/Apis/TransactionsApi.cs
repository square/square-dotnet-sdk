...
namespace Square.Legacy.Apis
{
    ...
    internal class TransactionsApi : BaseApi, ITransactionsApi
    {
        ...
        /// </summary>
        internal TransactionsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.ListTransactionsResponse ListTransactions(
            ...
            CoreHelper.RunTask(
                ListTransactionsAsync(locationId, beginTime, endTime, sortOrder, cursor)
            );
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                .Template(_template => _template.Setup("location_id", locationId))
                                .Template(_template =>
                                    _template.Setup("transaction_id", transactionId)
                                )
                        )
                )
                .ResponseHandler(_responseHandler =>
