...
namespace Square.Legacy.Apis
{
    ...
    internal class VendorsApi : BaseApi, IVendorsApi
    {
        ...
        /// </summary>
        internal VendorsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.CreateVendorResponse CreateVendor(Models.CreateVendorRequest body) =>
        ...
        public Models.SearchVendorsResponse SearchVendors(Models.SearchVendorsRequest body) =>
        ...
        public Models.RetrieveVendorResponse RetrieveVendor(string vendorId) =>
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("vendor_id", vendorId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
