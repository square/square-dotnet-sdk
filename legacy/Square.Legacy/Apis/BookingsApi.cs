...
namespace Square.Legacy.Apis
{
    ...
    internal class BookingsApi : BaseApi, IBookingsApi
    {
        ...
        /// </summary>
        internal BookingsApi(GlobalConfiguration globalConfiguration)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.RetrieveBusinessBookingProfileResponse response from the API call.</returns>
        public async Task<Models.RetrieveBusinessBookingProfileResponse> RetrieveBusinessBookingProfileAsync(
            CancellationToken cancellationToken = default
        ) =>
        ...
        public Models.ListTeamMemberBookingProfilesResponse ListTeamMemberBookingProfiles(
            ...
            CoreHelper.RunTask(
                ListTeamMemberBookingProfilesAsync(bookableOnly, limit, cursor, locationId)
            );
                ...
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                .Query(_query =>
                                    _query.Setup("bookable_only", bookableOnly ?? false)
                                )
                                .Query(_query => _query.Setup("limit", limit))
                                .Query(_query => _query.Setup("cursor", cursor))
                                .Query(_query => _query.Setup("location_id", locationId))
            ...
            await CreateApiCall<Models.RetrieveBookingResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("booking_id", bookingId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
