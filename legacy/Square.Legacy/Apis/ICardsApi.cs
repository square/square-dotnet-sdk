...
namespace Square.Legacy.Apis
{
    ...
    public interface ICardsApi
    {
        ...
        Models.CreateCardResponse CreateCard(Models.CreateCardRequest body);
        ...
        Models.RetrieveCardResponse RetrieveCard(string cardId);
        ...
        Models.DisableCardResponse DisableCard(string cardId);
