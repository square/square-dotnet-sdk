...
namespace Square.Legacy.Apis
{
    ...
    public interface ITeamApi
    {
        ...
        Models.ListJobsResponse ListJobs(string cursor = null);
        ...
        Models.CreateJobResponse CreateJob(Models.CreateJobRequest body);
        ...
        Models.RetrieveJobResponse RetrieveJob(string jobId);
        ...
        Models.UpdateJobResponse UpdateJob(string jobId, Models.UpdateJobRequest body);
