...
namespace Square.Legacy.Apis
{
    ...
    internal class OrdersApi : BaseApi, IOrdersApi
    {
        ...
        /// </summary>
        internal OrdersApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.CloneOrderResponse CloneOrder(Models.CloneOrderRequest body) =>
            ...
            await CreateApiCall<Models.RetrieveOrderResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .WithAuth("global")
                        .Parameters(_parameters =>
                            _parameters.Template(_template => _template.Setup("order_id", orderId))
                        )
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
