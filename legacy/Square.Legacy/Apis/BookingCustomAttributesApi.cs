...
namespace Square.Legacy.Apis
{
    ...
    internal class BookingCustomAttributesApi : BaseApi, IBookingCustomAttributesApi
    {
        ...
        /// </summary>
        internal BookingCustomAttributesApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.ListBookingCustomAttributesResponse ListBookingCustomAttributes(
            ...
            CoreHelper.RunTask(
                ListBookingCustomAttributesAsync(bookingId, limit, cursor, withDefinitions)
            );
        ...
        public Models.RetrieveBookingCustomAttributeResponse RetrieveBookingCustomAttribute(
            ...
            CoreHelper.RunTask(
                RetrieveBookingCustomAttributeAsync(bookingId, key, withDefinition, version)
            );
