...
namespace Square.Legacy.Apis
{
    ...
    internal class GiftCardsApi : BaseApi, IGiftCardsApi
    {
        ...
        /// </summary>
        internal GiftCardsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.CreateGiftCardResponse CreateGiftCard(Models.CreateGiftCardRequest body) =>
        ...
        public Models.RetrieveGiftCardResponse RetrieveGiftCard(string id) =>
