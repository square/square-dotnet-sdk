...
namespace Square.Legacy.Apis
{
    ...
    internal class OrderCustomAttributesApi : BaseApi, IOrderCustomAttributesApi
    {
        ...
        /// </summary>
        internal OrderCustomAttributesApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.ListOrderCustomAttributeDefinitionsResponse ListOrderCustomAttributeDefinitions(
            ...
            CoreHelper.RunTask(
                ListOrderCustomAttributeDefinitionsAsync(visibilityFilter, cursor, limit)
            );
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                .Template(_template => _template.Setup("order_id", orderId))
                                .Template(_template =>
                                    _template.Setup("custom_attribute_key", customAttributeKey)
                                )
                        )
                )
                .ResponseHandler(_responseHandler =>
