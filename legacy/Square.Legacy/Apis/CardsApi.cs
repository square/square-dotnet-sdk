...
namespace Square.Legacy.Apis
{
    ...
    internal class CardsApi : BaseApi, ICardsApi
    {
        ...
        /// </summary>
        internal CardsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.ListCardsResponse ListCards(
            ...
            CoreHelper.RunTask(
                ListCardsAsync(cursor, customerId, includeDisabled, referenceId, sortOrder)
            );
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                ...
                                .Query(_query =>
                                    _query.Setup("include_disabled", includeDisabled ?? false)
                                )
        ...
        public Models.CreateCardResponse CreateCard(Models.CreateCardRequest body) =>
        ...
        public Models.RetrieveCardResponse RetrieveCard(string cardId) =>
            ...
            await CreateApiCall<Models.RetrieveCardResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .WithAuth("global")
                        .Parameters(_parameters =>
                            _parameters.Template(_template => _template.Setup("card_id", cardId))
                        )
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
        ...
        public Models.DisableCardResponse DisableCard(string cardId) =>
