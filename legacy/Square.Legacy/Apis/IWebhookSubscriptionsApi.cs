...
namespace Square.Legacy.Apis
{
    ...
    public interface IWebhookSubscriptionsApi
    {
        ...
        Models.ListWebhookEventTypesResponse ListWebhookEventTypes(string apiVersion = null);
        ...
        Models.DeleteWebhookSubscriptionResponse DeleteWebhookSubscription(string subscriptionId);
