...
namespace Square.Legacy.Apis
{
    ...
    internal class InventoryApi : BaseApi, IInventoryApi
    {
        ...
        /// </summary>
        internal InventoryApi(GlobalConfiguration globalConfiguration)
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("adjustment_id", adjustmentId)
                            )
                        )
                )
            ...
            await CreateApiCall<Models.RetrieveInventoryPhysicalCountResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("physical_count_id", physicalCountId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
            ...
            await CreateApiCall<Models.RetrieveInventoryTransferResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("transfer_id", transferId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
                ...
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                .Template(_template =>
                                    _template.Setup("catalog_object_id", catalogObjectId)
                                )
