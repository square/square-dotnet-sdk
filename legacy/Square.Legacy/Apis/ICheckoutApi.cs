...
namespace Square.Legacy.Apis
{
    ...
    public interface ICheckoutApi
    {
        ...
        Models.RetrieveLocationSettingsResponse RetrieveLocationSettings(string locationId);
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.RetrieveMerchantSettingsResponse response from the API call.</returns>
        Task<Models.RetrieveMerchantSettingsResponse> RetrieveMerchantSettingsAsync(
            CancellationToken cancellationToken = default
        );
        ...
        Models.ListPaymentLinksResponse ListPaymentLinks(string cursor = null, int? limit = null);
        ...
        Models.CreatePaymentLinkResponse CreatePaymentLink(Models.CreatePaymentLinkRequest body);
        ...
        Models.DeletePaymentLinkResponse DeletePaymentLink(string id);
        ...
        Models.RetrievePaymentLinkResponse RetrievePaymentLink(string id);
