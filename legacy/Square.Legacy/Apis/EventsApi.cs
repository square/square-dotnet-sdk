...
namespace Square.Legacy.Apis
{
    ...
    internal class EventsApi : BaseApi, IEventsApi
    {
        ...
        /// </summary>
        internal EventsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.SearchEventsResponse SearchEvents(Models.SearchEventsRequest body) =>
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.DisableEventsResponse response from the API call.</returns>
        public async Task<Models.DisableEventsResponse> DisableEventsAsync(
            CancellationToken cancellationToken = default
        ) =>
            await CreateApiCall<Models.DisableEventsResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder.Setup(HttpMethod.Put, "/v2/events/disable").WithAuth("global")
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
                        (_result, _context) => _result.ContextSetter(_context)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.EnableEventsResponse response from the API call.</returns>
        public async Task<Models.EnableEventsResponse> EnableEventsAsync(
            CancellationToken cancellationToken = default
        ) =>
            await CreateApiCall<Models.EnableEventsResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder.Setup(HttpMethod.Put, "/v2/events/enable").WithAuth("global")
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
                        (_result, _context) => _result.ContextSetter(_context)
        ...
        public Models.ListEventTypesResponse ListEventTypes(string apiVersion = null) =>
            ...
            await CreateApiCall<Models.ListEventTypesResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .WithAuth("global")
                        .Parameters(_parameters =>
                            _parameters.Query(_query => _query.Setup("api_version", apiVersion))
                        )
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
