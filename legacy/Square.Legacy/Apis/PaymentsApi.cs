...
namespace Square.Legacy.Apis
{
    ...
    internal class PaymentsApi : BaseApi, IPaymentsApi
    {
        ...
        /// </summary>
        internal PaymentsApi(GlobalConfiguration globalConfiguration)
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters
                                ...
                                .Query(_query =>
                                    _query.Setup("is_offline_payment", isOfflinePayment ?? false)
                                )
                                .Query(_query =>
                                    _query.Setup("offline_begin_time", offlineBeginTime)
                                )
                                .Query(_query => _query.Setup("offline_end_time", offlineEndTime))
                                .Query(_query =>
                                    _query.Setup("updated_at_begin_time", updatedAtBeginTime)
                                )
                                .Query(_query =>
                                    _query.Setup("updated_at_end_time", updatedAtEndTime)
                                )
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("payment_id", paymentId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
