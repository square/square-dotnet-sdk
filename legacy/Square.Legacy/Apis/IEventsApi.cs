...
namespace Square.Legacy.Apis
{
    ...
    public interface IEventsApi
    {
        ...
        Models.SearchEventsResponse SearchEvents(Models.SearchEventsRequest body);
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.DisableEventsResponse response from the API call.</returns>
        Task<Models.DisableEventsResponse> DisableEventsAsync(
            CancellationToken cancellationToken = default
        );
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.EnableEventsResponse response from the API call.</returns>
        Task<Models.EnableEventsResponse> EnableEventsAsync(
            CancellationToken cancellationToken = default
        );
        ...
        Models.ListEventTypesResponse ListEventTypes(string apiVersion = null);
