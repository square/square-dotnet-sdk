...
namespace Square.Legacy.Apis
{
    ...
    public interface ISnippetsApi
    {
        ...
        Models.DeleteSnippetResponse DeleteSnippet(string siteId);
        ...
        Models.RetrieveSnippetResponse RetrieveSnippet(string siteId);
        ...
        Models.UpsertSnippetResponse UpsertSnippet(string siteId, Models.UpsertSnippetRequest body);
