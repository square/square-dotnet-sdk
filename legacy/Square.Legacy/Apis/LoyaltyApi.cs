...
namespace Square.Legacy.Apis
{
    ...
    internal class LoyaltyApi : BaseApi, ILoyaltyApi
    {
        ...
        /// </summary>
        internal LoyaltyApi(GlobalConfiguration globalConfiguration)
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("account_id", accountId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
        ...
        /// <returns>Returns the Models.ListLoyaltyProgramsResponse response from the API call.</returns>
        [Obsolete]
        public async Task<Models.ListLoyaltyProgramsResponse> ListLoyaltyProgramsAsync(
            CancellationToken cancellationToken = default
        ) =>
            await CreateApiCall<Models.ListLoyaltyProgramsResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder.Setup(HttpMethod.Get, "/v2/loyalty/programs").WithAuth("global")
                )
                .ResponseHandler(_responseHandler =>
                    _responseHandler.ContextAdder(
                        (_result, _context) => _result.ContextSetter(_context)
        ...
        public Models.RetrieveLoyaltyProgramResponse RetrieveLoyaltyProgram(string programId) =>
            ...
            await CreateApiCall<Models.RetrieveLoyaltyProgramResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("program_id", programId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
            ...
            await CreateApiCall<Models.DeleteLoyaltyRewardResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("reward_id", rewardId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
