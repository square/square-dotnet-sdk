...
namespace Square.Legacy.Apis
{
    ...
    internal class TerminalApi : BaseApi, ITerminalApi
    {
        ...
        /// </summary>
        internal TerminalApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.GetTerminalActionResponse GetTerminalAction(string actionId) =>
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("action_id", actionId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
        ...
        public Models.CancelTerminalActionResponse CancelTerminalAction(string actionId) =>
        ...
        public Models.DismissTerminalActionResponse DismissTerminalAction(string actionId) =>
            ...
            await CreateApiCall<Models.GetTerminalCheckoutResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("checkout_id", checkoutId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
        ...
        public Models.DismissTerminalCheckoutResponse DismissTerminalCheckout(string checkoutId) =>
            ...
            await CreateApiCall<Models.GetTerminalRefundResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("terminal_refund_id", terminalRefundId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
