...
namespace Square.Legacy.Apis
{
    ...
    internal class MerchantCustomAttributesApi : BaseApi, IMerchantCustomAttributesApi
    {
        ...
        /// </summary>
        internal MerchantCustomAttributesApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.ListMerchantCustomAttributeDefinitionsResponse ListMerchantCustomAttributeDefinitions(
            ...
            CoreHelper.RunTask(
                ListMerchantCustomAttributeDefinitionsAsync(visibilityFilter, limit, cursor)
            );
        ...
        public Models.RetrieveMerchantCustomAttributeResponse RetrieveMerchantCustomAttribute(
            ...
            CoreHelper.RunTask(
                RetrieveMerchantCustomAttributeAsync(merchantId, key, withDefinition, version)
            );
