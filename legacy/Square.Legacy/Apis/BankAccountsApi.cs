...
namespace Square.Legacy.Apis
{
    ...
    internal class BankAccountsApi : BaseApi, IBankAccountsApi
    {
        ...
        /// </summary>
        internal BankAccountsApi(GlobalConfiguration globalConfiguration)
                    ...
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("v1_bank_account_id", v1BankAccountId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
            ...
            await CreateApiCall<Models.GetBankAccountResponse>()
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template =>
                                _template.Setup("bank_account_id", bankAccountId)
                            )
                        )
                )
                .ResponseHandler(_responseHandler =>
