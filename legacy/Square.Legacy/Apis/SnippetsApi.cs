...
namespace Square.Legacy.Apis
{
    ...
    internal class SnippetsApi : BaseApi, ISnippetsApi
    {
        ...
        /// </summary>
        internal SnippetsApi(GlobalConfiguration globalConfiguration)
        ...
        public Models.DeleteSnippetResponse DeleteSnippet(string siteId) =>
                ...
                .RequestBuilder(_requestBuilder =>
                    _requestBuilder
                        ...
                        .Parameters(_parameters =>
                            _parameters.Template(_template => _template.Setup("site_id", siteId))
                        )
                )
        ...
        public Models.RetrieveSnippetResponse RetrieveSnippet(string siteId) =>
