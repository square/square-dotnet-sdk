...
namespace Square.Legacy.Apis
{
    ...
    internal class CheckoutApi : BaseApi, ICheckoutApi
    {
        ...
        /// </summary>
        internal CheckoutApi(GlobalConfiguration globalConfiguration)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.RetrieveMerchantSettingsResponse response from the API call.</returns>
        public async Task<Models.RetrieveMerchantSettingsResponse> RetrieveMerchantSettingsAsync(
            CancellationToken cancellationToken = default
        ) =>
        ...
        public Models.DeletePaymentLinkResponse DeletePaymentLink(string id) =>
        ...
        public Models.RetrievePaymentLinkResponse RetrievePaymentLink(string id) =>
