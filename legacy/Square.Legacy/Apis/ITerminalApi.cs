...
namespace Square.Legacy.Apis
{
    ...
    public interface ITerminalApi
    {
        ...
        Models.GetTerminalActionResponse GetTerminalAction(string actionId);
        ...
        Models.CancelTerminalActionResponse CancelTerminalAction(string actionId);
        ...
        Models.DismissTerminalActionResponse DismissTerminalAction(string actionId);
        ...
        Models.DismissTerminalCheckoutResponse DismissTerminalCheckout(string checkoutId);
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.DismissTerminalCheckoutResponse response from the API call.</returns>
        Task<Models.DismissTerminalCheckoutResponse> DismissTerminalCheckoutAsync(
            string checkoutId,
            CancellationToken cancellationToken = default
        );
        ...
        Models.DismissTerminalRefundResponse DismissTerminalRefund(string terminalRefundId);
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.DismissTerminalRefundResponse response from the API call.</returns>
        Task<Models.DismissTerminalRefundResponse> DismissTerminalRefundAsync(
            string terminalRefundId,
            CancellationToken cancellationToken = default
        );
    }
