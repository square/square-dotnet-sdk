...
namespace Square.Legacy.Http.Client
{
    ...
    public class HttpClientConfiguration : IHttpClientConfiguration
    {
        ...
        {
            get => coreHttpClientConfiguration.Timeout;
        }
        ...
        {
            get => coreHttpClientConfiguration.NumberOfRetries;
        }
        ...
        {
            get => coreHttpClientConfiguration.BackoffFactor;
        }
        ...
        {
            get => coreHttpClientConfiguration.RetryInterval;
        }

        /// <summary>
        /// Gets The maximum retry wait time.
        /// </summary>
        public TimeSpan MaximumRetryWaitTime
        {
            get => coreHttpClientConfiguration.MaximumRetryWaitTime;
        }

        /// <summary>
        /// Gets List of Http status codes to invoke retry.
        /// </summary>
        public IList<int> StatusCodesToRetry
        {
            get => coreHttpClientConfiguration.StatusCodesToRetry;
        }

        /// <summary>
        /// Gets List of Http request methods to invoke retry.
        /// </summary>
        public IList<HttpMethod> RequestMethodsToRetry
        {
            get => coreHttpClientConfiguration.RequestMethodsToRetry;
        }
        ...
        {
            get => coreHttpClientConfiguration.HttpClientInstance;
        }
        ...
        /// </summary>
        public bool OverrideHttpClientConfiguration
        {
            get => coreHttpClientConfiguration.OverrideHttpClientConfiguration;
        }
        ...
        {
            internal CoreHttpClientConfiguration.Builder CoreHttpClientConfigurationBuilder
            {
                private get;
                set;
            ...
            {
                CoreHttpClientConfigurationBuilder = CoreHttpClientConfigurationBuilder.Timeout(
                    timeout
                );
                return this;
            }
            ...
            public Builder NumberOfRetries(int numberOfRetries)
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.NumberOfRetries(numberOfRetries);
                return this;
            }
            ...
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.BackoffFactor(backoffFactor);
                return this;
            }
            ...
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.RetryInterval(retryInterval);
                return this;
            }
            ...
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.MaximumRetryWaitTime(maximumRetryWaitTime);
                return this;
            }
            ...
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.StatusCodesToRetry(statusCodesToRetry);
                return this;
            }
            ...
            public Builder HttpClientInstance(
                ...
                bool overrideHttpClientConfiguration = true
            )
            {
                CoreHttpClientConfigurationBuilder =
                    CoreHttpClientConfigurationBuilder.HttpClientInstance(
                        httpClientInstance,
                        overrideHttpClientConfiguration
                    );
                return this;
