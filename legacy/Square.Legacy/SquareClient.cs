    ...
    public sealed class SquareClient : ISquareClient
    {
        ...
        private static readonly Dictionary<Environment, Dictionary<Enum, string>> EnvironmentsMap =
            new Dictionary<Environment, Dictionary<Enum, string>>
            {
                ...
                {
                    Environment.Custom,
                    new Dictionary<Enum, string> { { Server.Default, "{custom_url}" } }
                },
            };

        private readonly GlobalConfiguration globalConfiguration;
        private const string userAgent =
            "Square-DotNet-SDK/40.1.0 ({api-version}) {engine}/{engine-version} ({os-info}) {detail}";
        ...
        )
        {
            ...
            globalConfiguration = new GlobalConfiguration.Builder()
                .AuthManagers(
                    new Dictionary<string, AuthManager> { { "global", bearerAuthManager } }
                )
                ...
                .Parameters(globalParameter =>
                    globalParameter
                        .Header(headerParameter =>
                            headerParameter.Setup("Square-Version", this.SquareVersion)
                        )
                        .Template(templateParameter =>
                            templateParameter.Setup("custom_url", this.CustomUrl)
                        )
                )
                .RuntimeParameters(runtimeParameter =>
                    runtimeParameter.AdditionalHeaders(SetupAdditionalHeaders)
                )
            ...
            this.oAuth = new Lazy<IOAuthApi>(() => new OAuthApi(globalConfiguration));
            this.v1Transactions = new Lazy<IV1TransactionsApi>(
                () => new V1TransactionsApi(globalConfiguration)
            );
            this.applePay = new Lazy<IApplePayApi>(() => new ApplePayApi(globalConfiguration));
            this.bankAccounts = new Lazy<IBankAccountsApi>(
                () => new BankAccountsApi(globalConfiguration)
            );
            this.bookings = new Lazy<IBookingsApi>(() => new BookingsApi(globalConfiguration));
            this.bookingCustomAttributes = new Lazy<IBookingCustomAttributesApi>(
                () => new BookingCustomAttributesApi(globalConfiguration)
            );
            this.cards = new Lazy<ICardsApi>(() => new CardsApi(globalConfiguration));
            this.cashDrawers = new Lazy<ICashDrawersApi>(
                () => new CashDrawersApi(globalConfiguration)
            );
            this.catalog = new Lazy<ICatalogApi>(() => new CatalogApi(globalConfiguration));
            this.customers = new Lazy<ICustomersApi>(() => new CustomersApi(globalConfiguration));
            ...
            this.devices = new Lazy<IDevicesApi>(() => new DevicesApi(globalConfiguration));
            this.disputes = new Lazy<IDisputesApi>(() => new DisputesApi(globalConfiguration));
            this.employees = new Lazy<IEmployeesApi>(() => new EmployeesApi(globalConfiguration));
            this.events = new Lazy<IEventsApi>(() => new EventsApi(globalConfiguration));
            this.giftCards = new Lazy<IGiftCardsApi>(() => new GiftCardsApi(globalConfiguration));
            this.giftCardActivities = new Lazy<IGiftCardActivitiesApi>(
                () => new GiftCardActivitiesApi(globalConfiguration)
            );
            this.inventory = new Lazy<IInventoryApi>(() => new InventoryApi(globalConfiguration));
            this.invoices = new Lazy<IInvoicesApi>(() => new InvoicesApi(globalConfiguration));
            this.labor = new Lazy<ILaborApi>(() => new LaborApi(globalConfiguration));
            this.locations = new Lazy<ILocationsApi>(() => new LocationsApi(globalConfiguration));
            this.locationCustomAttributes = new Lazy<ILocationCustomAttributesApi>(
                () => new LocationCustomAttributesApi(globalConfiguration)
            );
            this.checkout = new Lazy<ICheckoutApi>(() => new CheckoutApi(globalConfiguration));
            this.transactions = new Lazy<ITransactionsApi>(
                () => new TransactionsApi(globalConfiguration)
            );
            this.loyalty = new Lazy<ILoyaltyApi>(() => new LoyaltyApi(globalConfiguration));
            this.merchants = new Lazy<IMerchantsApi>(() => new MerchantsApi(globalConfiguration));
            this.merchantCustomAttributes = new Lazy<IMerchantCustomAttributesApi>(
                () => new MerchantCustomAttributesApi(globalConfiguration)
            );
            this.orders = new Lazy<IOrdersApi>(() => new OrdersApi(globalConfiguration));
            this.orderCustomAttributes = new Lazy<IOrderCustomAttributesApi>(
                () => new OrderCustomAttributesApi(globalConfiguration)
            );
            this.payments = new Lazy<IPaymentsApi>(() => new PaymentsApi(globalConfiguration));
            this.payouts = new Lazy<IPayoutsApi>(() => new PayoutsApi(globalConfiguration));
            this.refunds = new Lazy<IRefundsApi>(() => new RefundsApi(globalConfiguration));
            this.sites = new Lazy<ISitesApi>(() => new SitesApi(globalConfiguration));
            this.snippets = new Lazy<ISnippetsApi>(() => new SnippetsApi(globalConfiguration));
            this.subscriptions = new Lazy<ISubscriptionsApi>(
                () => new SubscriptionsApi(globalConfiguration)
            );
            this.team = new Lazy<ITeamApi>(() => new TeamApi(globalConfiguration));
            this.terminal = new Lazy<ITerminalApi>(() => new TerminalApi(globalConfiguration));
            this.vendors = new Lazy<IVendorsApi>(() => new VendorsApi(globalConfiguration));
        ...
        /// </summary>
        public IBookingCustomAttributesApi BookingCustomAttributesApi =>
            this.bookingCustomAttributes.Value;
        ...
        /// </summary>
        public ICustomerCustomAttributesApi CustomerCustomAttributesApi =>
            this.customerCustomAttributes.Value;
        ...
        /// </summary>
        public ILocationCustomAttributesApi LocationCustomAttributesApi =>
            this.locationCustomAttributes.Value;
        ...
        /// </summary>
        public IMerchantCustomAttributesApi MerchantCustomAttributesApi =>
            this.merchantCustomAttributes.Value;
        ...
        /// </summary>
        public IOrderCustomAttributesApi OrderCustomAttributesApi =>
            this.orderCustomAttributes.Value;
        ...
        /// </summary>
        public IDictionary<string, List<string>> AdditionalHeaders =>
            this.additionalHeaders.ToDictionary(s => s.Key, s => new List<string>(s.Value));
        ...
        {
            return $"SquareVersion = {this.SquareVersion}, "
                + $"UserAgentDetail = {this.UserAgentDetail}, "
                + $"Environment = {this.Environment}, "
                + $"CustomUrl = {this.CustomUrl}, "
        ...
        internal static SquareClient CreateFromEnvironment()
        {
            ...
            string squareVersion = System.Environment.GetEnvironmentVariable(
                "SQUARE_SQUARE_VERSION"
            );
        ...
        public class Builder
        {
            ...
            private Environment environment = Square.Legacy.Environment.Production;
            private string customUrl = "https://connect.squareup.com";
            private BearerAuthModel bearerAuthModel = new BearerAuthModel();
            private HttpClientConfiguration.Builder httpClientConfig =
            ...
            /// <returns>Builder.</returns>
            [Obsolete(
                "This method is deprecated. Use BearerAuthCredentials(bearerAuthModel) instead."
            )]
            public Builder AccessToken(string accessToken)
            {
                bearerAuthModel = bearerAuthModel.ToBuilder().AccessToken(accessToken).Build();
                return this;
            }
            ...
            {
                this.squareVersion =
                    squareVersion ?? throw new ArgumentNullException(nameof(squareVersion));
                return this;
            }
            ...
            {
                if (userAgentDetail != null && userAgentDetail.Count() > 128)
            ...
            public Builder AdditionalHeaders(IDictionary<string, List<string>> additionalHeaders)
            {
                ...
                this.additionalHeaders = additionalHeaders.ToDictionary(
                    s => s.Key,
            ...
            public Builder AddAdditionalHeader(string headerName, string headerValue)
            {
                ...
                {
                    throw new ArgumentException(
                        "Header name can not be null, empty or whitespace.",
                        nameof(headerName)
                    );
                }
                ...
                if (
                    this.additionalHeaders.ContainsKey(headerName)
                    && this.additionalHeaders[headerName] != null
                )
                {
