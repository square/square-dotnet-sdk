...
namespace Square.Legacy.Utilities
{
    ...
    public static class WebhooksHelper
    {
        ...
        /// <returns>
        /// <c>true</c> if the signature is valid, indicating that the event can be trusted as it came from Square.Legacy.
        ...
        ///             throw new System.Exception("A webhook event was received that was not from Square.Legacy.");
        ///         }
        ///     }
        /// }
        /// </code>
